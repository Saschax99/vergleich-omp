<?php
	...
	$sql_header = 'SELECT * FROM '.$db_header.' WHERE header LIKE "%'.$input.'%"';
...
<!DOCTYPE html>
	...
	<head>
		<meta charset="UTF-8">
		<title>suche nach <?php echo $input; ?> - omp</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="description" content="Um Sie bei der Kaufentscheidung eines <?php echo $input; ?> zu unterstützen, haben wir für Sie die Besten Produkte ermittelt!">
	...
	<div class="wrapper">
		...
		<section id="counter" class="wow fadeInDown">
			<div class="container">
				<div class="row">
					<div class="title">
						<h2>suche nach <?php echo $input; ?></h2>
						<?php 
						if (mysqli_num_rows($query_header) == 0) // check if query is empty
						{
							?>
